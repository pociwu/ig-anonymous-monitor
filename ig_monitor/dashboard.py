...
<style>.media img{object-fit:contain}.lightbox-stage{overflow:hidden}.lightbox-image{position:absolute;inset:0;width:100%;height:100%;object-fit:contain}</style>
